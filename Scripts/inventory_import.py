...
if __name__ == "__main__":
  ...
  parser.add_argument("-db", "--database", default='rugs', required=False, help = "Database Name")

  # Read arguments from command line
  args = parser.parse_args()

	# Load CSV to DB
  inv = InventoryImport(args.host, args.database, args.user_name,args.password)
